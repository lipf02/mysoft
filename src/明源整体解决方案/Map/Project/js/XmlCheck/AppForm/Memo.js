function MemoXml(item, section, tab) {
    ...
    new Memo(name, field, title, req, colspan, createapi, updateapi,
...
function DefaultMemo(tabIndex, sectionIndex) {
    new Memo("", "", "", "0", "1", "1", "1", "", "", "right", "", "", "", "", "", "", "", "", "", "", tabIndex, sectionIndex);
}
function Memo(name, field, title, req, colspan, createapi, updateapi, 
    assistanticon, iconwidth, iconalign, iconclick, icontip, defaultvalue, editvalue,
    maxlength, forbiddenchars, allowchars, onchange, onclick, ondblclick,
    tabIndex, sectionIndex) {
    this.data = new Array();
...
Memo.prototype.ToHtml = function () {
    var html = "<div style=\"padding-left:40px;\">&lt;item type=\"memo\" ";
...
Memo.prototype.ToXml = function () {
    var Textxml = "<item type=\"memo\"><attribute /></item>";
