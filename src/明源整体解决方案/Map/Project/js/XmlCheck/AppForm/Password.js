function PasswordXml(item, section, tab) {
    ...
    var iconalign = item.getAttribute("iconalign");
    ...
    new Password(name, field, title, req, colspan, createapi, updateapi,
...
function DefaultPassword(tabIndex, sectionIndex) {
    new Password("", "", "", "0", "1", "1", "1", "", "", "right", "", "", "", "", "", "", "", "", "", "", tabIndex, sectionIndex);
}
function Password(name, field, title, req, colspan, createapi, updateapi, 
    assistanticon, iconwidth, iconalign, iconclick, icontip, defaultvalue, editvalue,
    maxlength, forbiddenchars, allowchars, onchange, onclick, ondblclick,
    tabIndex, sectionIndex) {
    this.data = new Array();
...
Password.prototype.ToHtml = function () {
    var html = "<div style=\"padding-left:40px;\">&lt;item type=\"password\" ";
    ...
    html += TextControl("iconalign", this);
    html += "<br/><span style=\"padding-left:38px;\">&nbsp;</span>"
...
Password.prototype.ToXml = function () {
    var Textxml = "<item type=\"password\"><attribute /></item>";
